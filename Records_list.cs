...
{
    public partial class Records_list : Form
    {
        public Records_list()
        {
            InitializeComponent();
        ...
        private void Records_list_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "radiostationDataSet0.records_list". При необходимости она может быть перемещена или удалена.
            this.records_listTableAdapter.Fill(this.radiostationDataSet0.records_list);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            records_listTableAdapter.Update(radiostationDataSet0.records_list);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            /*AddFor8 af = new AddForm8();
            af.Owner = this;
            af.Show();*/
        }
